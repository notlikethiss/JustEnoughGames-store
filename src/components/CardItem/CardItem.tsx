	...
	<div className='carditem'>
		<Link to={privateURL} className='carditem-link'>
			<div 
				...
				style={{backgroundImage: product.image ? `url(${product.image})` : `url(${loadingImage})`}}
			>
			</div>
		</Link>
